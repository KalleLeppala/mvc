...
#                        (for example with PI HAT > 0,2) remain.
# output                 Name for the output text file, defaults to "samples to remove, txt".
...
def samples_to_remove(genome, output = "samples to remove.txt", cases_over_controls = True, family = ""):
